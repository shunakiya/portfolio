  ...
  return (
    <div className="flex flex-col mb-1">
      ...
      <div className="grid grid-cols-2 grid-rows-3 lg:grid-cols-3 lg:grid-rows-2 md:grid-cols-3 md:grid-rows-2 sm:grid-cols-2 sm:grid-rows-3 gap-4">
        <div className="group flex flex-row items-center bg-slate-800 p-2 rounded-lg px-3 w-40 lg:w-52 md:w-52 sm:w-52 py-2.5 border border-transparent transition-all duration-150 ease-in-out hover:border-slate-600">
        ...
        <div className="relative group flex flex-row items-center bg-slate-800 p-2 rounded-lg px-3 w-40 lg:w-52 md:w-52 sm:w-52 py-2.5 border border-transparent transition-all duration-150 ease-in-out hover:border-slate-600">
